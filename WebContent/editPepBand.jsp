...
Band Name: <input type="text" name="bandName" value="${pepBandToEdit.bandName}">
Band Location: <input type="text" name="bandLocation" value="${pepBandToEdit.bandLocation}">
Number of Members: <input type="text" name="numOfMembers" value="${pepBandToEdit.numOfMembers}">
